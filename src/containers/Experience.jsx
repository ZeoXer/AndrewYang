...
const Experience = ({ id, bgName }) => {
  const experienceList = [
    ...
    },
    {
      ...
      title: "mrhost 實習",
      description:
        "在網路上偶然得知公司招募實習生的資訊，當時已經累積一些技術的我於是毅然決然決定挑戰自己，最後也幸運地獲得實習機會，在公司的這段時間內學到了很多新的知識和技術，除了運用原先會的 Python 網路爬蟲協助公司進行資料蒐集的工作，後續也根據需求學習了 Google App Script 進行 Google Sheet 表單資料的整合，以及鑽研 Golang 為專案架設伺服器、撰寫後端 API，近期也接觸到 Nextjs 框架配合 UI 設計師打造完整的前端網頁。",
    },
    {
      id: 5,
      icon: "bg-nccu",
      time: "2023.9 - Now",
      title: "國立政治大學 資訊科學研究所",
      description:
        "從台大畢業並接觸資訊領域一段時間後，我決定繼續精進自己的資訊相關技能和知識，因此選擇報考政大資訊所，並且順利通過考試取得錄取資格。入學後，我選擇朝向通訊網路相關的領域進行更深入的研究摸索，在就學的這段時間內，我將會學習更多的資訊科學相關知識以及研究方法，為未來的職涯做好準備。",
    },
  ];
